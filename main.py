...
game_model = Model(_viewer=viewer, _fps=60, _ruleset=rulesets.Conway(), _total_generations=-1,_width=50, _height=50)
game_controller = Controller(game_model, viewer, config)

clock = pygame.time.Clock()
running = True
while running:
    if viewer.interactable: game_controller.read_input()
